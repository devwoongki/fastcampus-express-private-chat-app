...
msgForm.addEventListener('submit', (e) => {
    ...
    const to = title.getAttribute('userID');
    const time = new Date().toLocaleDateString('en-US',{hour:'numeric', minute:'numeric', hour12: true});
